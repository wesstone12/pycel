...
class RuntimeRecord {
    ...
    getKey() {
        return Converter._generateRuntimeLookupKey(this._resource, this._lifetime, this._versionOverrideCapabilities, this._inputFormFactor, this._source);
    }
}
...
class Converter {
    ...
    _populateRoot(context) {
        ...
        if (!utilities_1.Utilities.isNullOrUndefined(utilities_1.Utilities._schemaOverride)) {
            this._mosManifest.$schema = utilities_1.Utilities._schemaOverride;
        }
        this._mosManifest.manifestVersion = constants_1.Constants.MosManifestGAVersion_1_17;
        if (!utilities_1.Utilities.isNullOrUndefined(utilities_1.Utilities._schemaVersionOverride)) {
            this._mosManifest.manifestVersion = utilities_1.Utilities._schemaVersionOverride;
        }
    ...
    _populateWebApplicationInfoFromMailbox() {
        ...
        for (let overrideIndex of overrideIndexes) {
            ...
            if (utilities_1.Utilities.isNullOrUndefined(webApplicationInfo) ||
                (utilities_1.Utilities.isNullOrUndefined(webApplicationInfo["_webApplicationId"]) &&
                    utilities_1.Utilities.isNullOrUndefined(webApplicationInfo["_webApplicationResource"]))) {
                continue;
            }
            ...
            if (utilities_1.Utilities.isNullOrUndefined(this._mosManifest.webApplicationInfo)) {
                ...
                utilities_1.Utilities.logError("MetaOS schema currently only supports one webapplicationInfo but we have found more than one in this manifest MailHost override: " +
                    overrideIndex +
                    ". " +
                    " app: " +
    ...
    _populateAlternates(extension) {
        ...
        if (!utilities_1.Utilities.isNullOrUndefined(iconUrl) || !utilities_1.Utilities.isNullOrUndefined(highResolutionIconUrl)) {
    ...
    _populateAutoRunEvents(context, extension) {
        ...
        for (let overrideId of overrides) {
            let addinCommandsExtensionPointsDesktop = Converter._getAddinCommandsExtensionPoints(constants_1.Constants.InputMailHost, overrideId, constants_1.Constants.InputDesktopFormFactor, this._xmlManifest);
            let addinCommandsExtensionPointsMobile = Converter._getAddinCommandsExtensionPoints(constants_1.Constants.InputMailHost, overrideId, constants_1.Constants.InputMobileFormFactor, this._xmlManifest);
            ...
            if (!utilities_1.Utilities.isNullOrUndefined(addinCommandsExtensionPointsDesktop)) {
                context.setFormFactor(constants_1.Constants.InputDesktopFormFactor);
                this._populateAutoRunEventsForFormFactor(context, addinCommandsExtensionPointsDesktop, constants_1.Constants.InputDesktopFormFactor, autoRunEvents);
                context.setFormFactor(null);
            }
            if (!utilities_1.Utilities.isNullOrUndefined(addinCommandsExtensionPointsMobile)) {
                context.setFormFactor(constants_1.Constants.InputMobileFormFactor);
                this._populateAutoRunEventsForFormFactor(context, addinCommandsExtensionPointsMobile, constants_1.Constants.InputMobileFormFactor, autoRunEvents);
                context.setFormFactor(null);
            }
    ...
    _populateAutoRunEventsForFormFactor(context, addinCommandsExtensionPoints, formFactor, autoRunEvents) {
            ...
            if (extensionPoint[constants_1.Constants.InputType] === constants_1.Constants.InputLaunchEvent &&
                ...
                for (let innerEvent of extensionPoint[constants_1.Constants.InputEvents]) {
                    if (utilities_1.Utilities.isNullOrUndefined(autoRunEvent)) {
                        ...
                        if (!utilities_1.Utilities.isNullOrUndefined(context.getFormFactor())) {
                    ...
                    const runtimeKey = Converter._generateRuntimeLookupKey(runtimeUrl, MOS.RuntimesLifetime.Short, context.getCurrentVersionOverrideCapabilities(), context.getFormFactor());
    ...
    _fillGetStartedMessagesFromVersionOverrides(context, extension, manifestHostType) {
        ...
        if (!utilities_1.Utilities.isNullOrUndefined(getStartedNode)) {
            ...
            let scope = Converter._getRequirementsScopeFromManifestHostType(manifestHostType);
    ...
    _addRibbonOrContextMenuForHostType(context, manifestHostType, ribbons, contextMenus) {
        ...
        if (Converter._isWXP(hostType)) {
            ...
            if (!utilities_1.Utilities.isNullOrUndefined(functionFileResid) &&
                !utilities_1.Utilities.isNullOrUndefined(functionFileResid[constants_1.Constants.InputDesktopFormFactor])) {
            ...
            for (let vo of supportedVersionOverrides) {
                ...
                if (!utilities_1.Utilities.isNullOrUndefined(addinCommandsExtensionPoints)) {
                    ...
                    if (!utilities_1.Utilities.isNullOrUndefined(functionFileResidVersion) &&
                        !utilities_1.Utilities.isNullOrUndefined(functionFileResidVersion[constants_1.Constants.InputDesktopFormFactor])) {
                ...
                if (!utilities_1.Utilities.isNullOrUndefined(addinCommandsExtensionPointsMobile) &&
                    ...
                    let functionFileResidVersion = Converter._getFunctionFileResid(hostType, vo, this._xmlManifest);
                    if (!utilities_1.Utilities.isNullOrUndefined(functionFileResidVersion) &&
                        !utilities_1.Utilities.isNullOrUndefined(functionFileResidVersion[constants_1.Constants.InputMobileFormFactor])) {
            ...
            if (Converter._isRibbonCommandSurface(extensionPointType)) {
                ...
                if (!utilities_1.Utilities.isNullOrUndefined(extPoint[constants_1.Constants.InputChildren])) {
                    for (let menuNodeIdx = 0; menuNodeIdx < extPoint[constants_1.Constants.InputChildren].length; menuNodeIdx++) {
                        ...
                        const mosMenu = new MOS.Menus();
                        mosMenu.entryPoint = menuNode[constants_1.Constants.InputType] === constants_1.Constants.InputContextMenuCell
                        ...
                        for (let menuControlIdx = 0; menuControlIdx < menuNode[constants_1.Constants.InputChildren].length; menuControlIdx++) {
                            const control = menuNode[constants_1.Constants.InputChildren][menuControlIdx];
                            context.setCurrentContextMenuMenuControlIndex(menuControlIdx);
                            if (utilities_1.Utilities.isNullOrUndefined(mosMenu.controls)) {
                                mosMenu.controls = [];
                            }
                            if (control[constants_1.Constants.InputControlType] === constants_1.Constants.InputMenu) {
                                let mosMenuMenu = new MOS.ExtensionCommonCustomControlMenu();
                                this._populateMenuControl(context, mosMenuMenu, control);
                                mosMenu.controls.push(mosMenuMenu);
                            }
                            else {
                                let mosButton = new MOS.ExtensionCommonCustomGroupControlsItem();
    ...
    _populateRibbonAndContextMenuRequirements(context, requirements) {
        ...
        if (!utilities_1.Utilities.isNullOrUndefined(context.getFormFactor())) {
            let formFactor = Converter._inputFormFactorToMOSFormFactor(context.getFormFactor());
    ...
    static _mergeInVersionOverrideRequirements(versionOverrideCapabilities, requirements) {
        ...
        for (let capability of versionOverrideCapabilities) {
            ...
            if (utilities_1.Utilities.isNullOrUndefined(matchingCapability)) {
                ...
                let existingMin = utilities_1.Utilities.isNullOrUndefined(matchingCapability.minVersion)
                    ? null
    ...
    _populateMenuControl(context, menuControl, control) {
        if (utilities_1.Utilities.isNullOrUndefined(control === null || control === void 0 ? void 0 : control[constants_1.Constants.InputChildren]) ||
            control[constants_1.Constants.InputChildren].length == 0) {
            return;
        }
        ...
        context.setCurrentContextMenuMenuControlMenuItemIndex(conversionContext_1.ConversionContext.UnsetIndex);
    }
    ...
    _populateControlProperties(context, mosControl, control) {
        ...
        if (control[constants_1.Constants.InputControlType] === constants_1.Constants.InputButton) {
            ...
            mosButton.overriddenByRibbonApi = utilities_1.Utilities.isNullOrUndefined(control[constants_1.Constants.InputOverridenByRibbonApi])
                ? false
            ...
            mosMenuItem.overriddenByRibbonApi = utilities_1.Utilities.isNullOrUndefined(control[constants_1.Constants.InputOverridenByRibbonApi])
                ? false
                : control[constants_1.Constants.InputOverridenByRibbonApi];
            isMenuItem = true;
        }
            ...
            mosMenu.overriddenByRibbonApi = utilities_1.Utilities.isNullOrUndefined(control[constants_1.Constants.InputOverridenByRibbonApi])
                ? false
                : control[constants_1.Constants.InputOverridenByRibbonApi];
        }
        else {
    ...
    _populateMobileControlProperties(context, mosMobileControl, control) {
        ...
        if (!utilities_1.Utilities.isNullOrUndefined(control[constants_1.Constants.InputLabel]) ||
            !utilities_1.Utilities.isNullOrUndefined(control[constants_1.Constants.InputLabelResId])) {
    ...
    _populateControlLocalizedField(context, labelResId, defaultValue, maxLength, resourceType, resourceString) {
        if (context.isInRibbon()) {
            return this._getResourceAndWriteLocalizedValues(labelResId, defaultValue, maxLength, context.getCurrentVersionOverrideNumber(), resourceString, resourceType, context.getCurrentRibbonIndex(), context.getCurrentTabIndex(), context.getCurrentCustomMobileGroupIndex() == conversionContext_1.ConversionContext.UnsetIndex
                ? context.getCurrentGroupIndex()
                : context.getCurrentCustomMobileGroupIndex(), context.getCurrentControlIndex(), context.getCurrentMenuItemIndex());
        }
        else {
    ...
    _populateControlAction(context, mosControl, control) {
        if (!utilities_1.Utilities.isNullOrUndefined(control) && !utilities_1.Utilities.isNullOrUndefined(control[constants_1.Constants.InputAction])) {
            let runtimeUrl = null;
            ...
            let runtime = null;
            let runtimeLookupKey = Converter._generateRuntimeLookupKey(runtimeUrl, MOS.RuntimesLifetime.Short, context.getCurrentVersionOverrideCapabilities(), context.getFormFactor());
    ...
    _populateControlIcons(context, mosControlIcons, icons, iconResIds, isMenuItem) {
        ...
        for (let size in icons) {
            ...
            if (context.isInRibbon()) {
                if (isMenuItem) {
                    this._getResourceAndWriteLocalizedValues(resId, fileShortName, constants_1.Constants.MaxResourceStringLength2048, context.getCurrentVersionOverrideNumber(), utilities_1.Utilities._writeImageUrls
                        ? constants_1.Constants.RibbonsTabsGroupsControlsItemsIconsUrl
                        : constants_1.Constants.RibbonsTabsGroupsControlsItemsIconsFile, ResourceType.AllLocaleImages, context.getCurrentRibbonIndex(), context.getCurrentTabIndex(), context.getCurrentGroupIndex(), context.getCurrentControlIndex(), context.getCurrentMenuItemIndex(), context.getCurrentIconIndex());
                }
                else {
                    this._getResourceAndWriteLocalizedValues(resId, fileShortName, constants_1.Constants.MaxResourceStringLength2048, context.getCurrentVersionOverrideNumber(), utilities_1.Utilities._writeImageUrls
                        ? constants_1.Constants.RibbonsTabsGroupsControlsIconsUrl
                        : constants_1.Constants.RibbonsTabsGroupsControlsIconsFile, ResourceType.AllLocaleImages, context.getCurrentRibbonIndex(), context.getCurrentTabIndex(), context.getCurrentGroupIndex(), context.getCurrentControlIndex(), context.getCurrentIconIndex());
                }
            }
            else {
                if (isMenuItem) {
                    this._getResourceAndWriteLocalizedValues(resId, fileShortName, constants_1.Constants.MaxResourceStringLength2048, context.getCurrentVersionOverrideNumber(), utilities_1.Utilities._writeImageUrls
                        ? constants_1.Constants.ContextMenusMenusControlsItemsIconsUrl
                        : constants_1.Constants.ContextMenusMenusControlsItemsIconsFile, ResourceType.AllLocaleImages, context.getCurrentContextMenuIndex(), context.getCurrentContextMenuMenuIndex(), context.getCurrentContextMenuMenuControlIndex(), context.getCurrentContextMenuMenuControlMenuItemIndex(), context.getCurrentIconIndex(), conversionContext_1.ConversionContext.UnsetIndex);
                }
                else {
                    this._getResourceAndWriteLocalizedValues(resId, fileShortName, constants_1.Constants.MaxResourceStringLength2048, context.getCurrentVersionOverrideNumber(), utilities_1.Utilities._writeImageUrls
                        ? constants_1.Constants.ContextMenusMenusControlsIconsUrl
                        : constants_1.Constants.ContextMenusMenusControlsIconsFile, ResourceType.AllLocaleImages, context.getCurrentContextMenuIndex(), context.getCurrentContextMenuMenuIndex(), context.getCurrentContextMenuMenuControlIndex(), context.getCurrentIconIndex(), conversionContext_1.ConversionContext.UnsetIndex);
                }
            }
            mosIcon.url = fileShortName;
            mosIcon.size = +size;
    ...
    _populateControlSupertip(context, mosControl, control) {
        ...
        if (mosControl[constants_1.Constants.MosType] === MOS.ExtensionCommonCustomGroupControlsItemType.Button) {
            ...
            mosButton.supertip.description = this._populateControlLocalizedField(context, supertip[constants_1.Constants.InputDescriptionResId], supertip[constants_1.Constants.InputDescription], constants_1.Constants.MaxResourceStringLength128, ResourceType.AllLocaleLongStrings, isRibbon
                ? constants_1.Constants.RibbonsTabsGroupsControlsSupertipDescription
            ...
            mosMenuItem.supertip.description = this._populateControlLocalizedField(context, supertip[constants_1.Constants.InputDescriptionResId], supertip[constants_1.Constants.InputDescription], constants_1.Constants.MaxResourceStringLength128, ResourceType.AllLocaleLongStrings, isRibbon
                ? constants_1.Constants.RibbonsTabsGroupsControlsItemsSupertipDescription
                : constants_1.Constants.ContextMenusMenusControlsItemsSupertipDescription);
            mosMenuItem.supertip.title = this._populateControlLocalizedField(context, supertip[constants_1.Constants.InputTitleResId], supertip[constants_1.Constants.InputTitle], constants_1.Constants.MaxResourceStringLength64, ResourceType.AllLocaleShortStrings, isRibbon
                ? constants_1.Constants.RibbonsTabsGroupsControlsItemsSupertipTitle
                : constants_1.Constants.ContextMenusMenusControlsItemsSupertipTitle);
        }
            ...
            mosMenu.supertip.description = this._populateControlLocalizedField(context, supertip[constants_1.Constants.InputDescriptionResId], supertip[constants_1.Constants.InputDescription], constants_1.Constants.MaxResourceStringLength128, ResourceType.AllLocaleLongStrings, isRibbon
                ? constants_1.Constants.RibbonsTabsGroupsControlsSupertipDescription
                : constants_1.Constants.ContextMenusMenusControlsSupertipDescription);
    ...
    _addScopesFromHosts(requirements) {
        ...
        if (requirements.scopes.length == 0) {
            if (!utilities_1.Utilities.isNullOrUndefined(this._xmlManifest._hostType) &&
                this._xmlManifest.getTarget() == osfmos_1.OSF.OfficeAppType.MailApp) {
                requirements.scopes.push(MOS.Scopes.Mail);
            }
        }
    }
    _populateRuntimes(context, extension) {
        ...
        this._runtimeLookup = {};
        this._createMosRuntimesFromRuntimeRecords(collectedRuntimeRecords, runtimes, contentRuntimes, this._runtimeLookup);
    ...
    _createMosRuntimesFromRuntimeRecords(runtimeRecords, runtimes, contentRuntimes, runtimeLookup) {
        if (runtimeRecords.length == 0) {
            console.error("\x1b[31m%s\x1b[0m", 'No supported runtime found in "' +
                utilities_1.Utilities._inputXmlFilePath +
        ...
        for (let idxRuntimeRecord = 0; idxRuntimeRecord < runtimeRecords.length; idxRuntimeRecord++) {
            ...
            if (runtimeRecord._source == RuntimeSource.DefaultSettingSourceLocations) {
                if (this._xmlManifest.getTarget() !== osfmos_1.OSF.OfficeAppType.ContentApp) {
                    continue;
                }
            }
            else {
            ...
            let rt = runtimeLookup[key];
            if (utilities_1.Utilities.isNullOrUndefined(rt)) {
                if (runtimeRecord._source == RuntimeSource.DefaultSettingSourceLocations) {
                ...
                rt[constants_1.Constants.MosId] = "runtime_" + this.getNextRuntimeSuffix();
                rt[constants_1.Constants.MosRequirements] = Converter._cloneRequirements(runtimeRecord._requirements);
                rt[constants_1.Constants.MosRequirements].capabilities = runtimeRecord._versionOverrideCapabilities;
                if (!utilities_1.Utilities.isNullOrUndefined(runtimeRecord._inputFormFactor)) {
                    let formFactor = Converter._legacyFormFactorToMOSFormFactor(runtimeRecord._inputFormFactor);
                    if (utilities_1.Utilities.isNullOrUndefined(rt[constants_1.Constants.MosRequirements])) {
                        rt[constants_1.Constants.MosRequirements] = new MOS.RequirementsExtensionElement();
                    }
                    if (utilities_1.Utilities.isNullOrUndefined(rt[constants_1.Constants.MosRequirements].formFactors)) {
                        rt[constants_1.Constants.MosRequirements].formFactors = [];
                    }
                    rt[constants_1.Constants.MosRequirements].formFactors.push(formFactor);
                }
                if (runtimeRecord._source == RuntimeSource.ShowTaskpane ||
                    ...
                    let contentRuntime = rt;
                    contentRuntime.disableSnapshot = !this._xmlManifest.isAllowSnapshot();
                    let osfFormFactor = runtimeRecord._inputFormFactor === constants_1.Constants.InputMobileFormFactor ? osfmos_1.OSF.FormFactor.Phone : osfmos_1.OSF.FormFactor.Desktop;
                    let defaultWidth = this._xmlManifest.getDefaultWidth(osfFormFactor);
                    let defaultHeight = this._xmlManifest.getDefaultHeight(osfFormFactor);
                    if (!utilities_1.Utilities.isNullOrUndefined(defaultWidth)) {
                        contentRuntime.requestedWidth = +defaultWidth;
                    }
                    if (!utilities_1.Utilities.isNullOrUndefined(defaultHeight)) {
                        contentRuntime.requestedHeight = +defaultHeight;
                    }
                    if (!utilities_1.Utilities.isNullOrUndefined(runtimeRecord._localeResources[this._xmlManifest.getDefaultLocale()])) {
                        contentRuntime[constants_1.Constants.MosCode].page = runtimeRecord._localeResources[this._xmlManifest.getDefaultLocale()];
                    }
                    else if (!utilities_1.Utilities.isNullOrUndefined(runtimeRecord._resource)) {
                        contentRuntime[constants_1.Constants.MosCode].page = runtimeRecord._resource;
                    }
                }
                else {
                ...
                utilities_1.Utilities.assert(!utilities_1.Utilities.isNullOrUndefined(rt[constants_1.Constants.MosCode].page), "runtime.code.page should not be null");
                if (runtimeRecord._source == RuntimeSource.DefaultSettingSourceLocations) {
                    contentRuntimes.push(rt);
                }
                else {
                    runtimes.push(rt);
                }
                ...
                if (!utilities_1.Utilities.isNullOrUndefined(runtimeRecord._localeResources)) {
                    for (let locale in runtimeRecord._localeResources) {
                        ...
                        if (!utilities_1.Utilities.isNullOrUndefined(rt[constants_1.Constants.MosCode].page)) {
                            let resourceName = null;
                            if (runtimeRecord._source == RuntimeSource.DefaultSettingSourceLocations) {
                                resourceTemplate = constants_1.Constants.ContentRuntimesPage;
                        ...
                        if (!utilities_1.Utilities.isNullOrUndefined(rt[constants_1.Constants.MosCode].script)) {
                    ...
                    for (let tabIdx = 0; tabIdx < extensionPoint[constants_1.Constants.InputTabs].length; tabIdx++) {
                        ...
                        if (!utilities_1.Utilities.isNullOrUndefined(tab[constants_1.Constants.InputChildren])) {
                            for (let groupIdx = 0; groupIdx < tab[constants_1.Constants.InputChildren].length; groupIdx++) {
                                ...
                                if (!utilities_1.Utilities.isNullOrUndefined(group) &&
                                    !utilities_1.Utilities.isNullOrUndefined(group[constants_1.Constants.InputChildren])) {
    ...
    static _getFunctionFileResid(versionOverrideHostIndex, versionOverrideIndex, xmlManifest) {
        ...
        if (!utilities_1.Utilities.isNullOrUndefined(xmlManifest._versionOverrides[versionOverrideHostIndex])) {
            if (utilities_1.Utilities.isNullOrUndefined(versionOverrideIndex) &&
                !utilities_1.Utilities.isNullOrUndefined(xmlManifest._versionOverrides[versionOverrideHostIndex][constants_1.Constants.InputFunctionFileResid])) {
                ...
                functionFileResid =
                    xmlManifest._versionOverrides[versionOverrideHostIndex][versionOverrideIndex][constants_1.Constants.InputFunctionFileResid];
            }
        }
    ...
    static _getAddinCommandsExtensionPoints(versionOverrideHostIndex, versionOverrideIndex, formFactor, xmlManifest) {
        ...
        if (!utilities_1.Utilities.isNullOrUndefined(xmlManifest._versionOverrides[versionOverrideHostIndex])) {
            if (utilities_1.Utilities.isNullOrUndefined(versionOverrideIndex) &&
                !utilities_1.Utilities.isNullOrUndefined(xmlManifest._versionOverrides[versionOverrideHostIndex][constants_1.Constants.InputAddinCommandsExtensionPoints])) {
                addinCommandsExtensionPoints =
                    xmlManifest._versionOverrides[versionOverrideHostIndex][constants_1.Constants.InputAddinCommandsExtensionPoints][formFactor];
            }
            else if (!utilities_1.Utilities.isNullOrUndefined(versionOverrideIndex) &&
                !utilities_1.Utilities.isNullOrUndefined(xmlManifest._versionOverrides[versionOverrideHostIndex][versionOverrideIndex]) &&
                ...
                addinCommandsExtensionPoints =
                    xmlManifest._versionOverrides[versionOverrideHostIndex][versionOverrideIndex][constants_1.Constants.InputAddinCommandsExtensionPoints][formFactor];
            }
        }
    ...
    static _cloneRequirements(requirements) {
        ...
        req.formFactors = !utilities_1.Utilities.isNullOrUndefined(requirements.formFactors)
    ...
    _addRuntimeForFormFactor(context, runtimeRecords, formFactor, sourceLocation) {
        let runtimeRecord = this._createRuntimeRecord(context, sourceLocation, new MOS.RequirementsExtensionElement(), RuntimeSource.DefaultSettingSourceLocations, null);
        for (let seenLocale in this._xmlManifest.getLocalesSeen()) {
    ...
    _createRuntimeRecord(context, resource, requirements, source, manifestHostType, scriptResId = null, lifetime = MOS.RuntimesLifetime.Short) {
        ...
        if (!utilities_1.Utilities.isNullOrUndefined(context)) {
            ...
            utilities_1.Utilities.logError("Expected the form factor to be set in the context for runtime: " + resource);
        }
        if (!utilities_1.Utilities.isNullOrUndefined(context) &&
            !utilities_1.Utilities.isNullOrUndefined(context.getCurrentVersionOverrideCapabilities())) {
    ...
    _getResourceAndWriteLocalizedValues(resId, defaultValue, maxLength, versionOverridesNumber, resourceTemplate, resourceType, index1 = undefined, index2 = undefined, index3 = undefined, index4 = undefined, index5 = undefined, index6 = undefined) {
        ...
        const defaultLocale = this._xmlManifest.getDefaultLocale().toLocaleLowerCase();
        if (utilities_1.Utilities.isNullOrUndefined(allLocaleResources[resId]) ||
            utilities_1.Utilities.isNullOrUndefined(allLocaleResources[resId][defaultLocale])) {
            return !utilities_1.Utilities.isNullOrUndefined(defaultValue) ? defaultValue : resId;
        }
        for (let seenLocale in this._xmlManifest.getLocalesSeen()) {
        ...
        const valueObtained = utilities_1.Utilities.isNullOrUndefined(defaultValue)
            ? allLocaleResources[resId][defaultLocale]
            : defaultValue;
        return maxLength == constants_1.Constants.MaxResourceStringLengthAny
            ? valueObtained
            : utilities_1.Utilities.truncateString(valueObtained, maxLength);
    }
    ...
    _addRuntimeExecuteAction(runtime, action, runtimeKey) {
        ...
        if (utilities_1.Utilities.isNullOrUndefined(this._addedExecuteFunctions[runtimeActionKey]) ||
    ...
    static _generateRuntimeLookupKey(url, lifetime, capabilities, formFactor = null, source = null) {
        let resultKey = url + lifetime.toString();
        if (source === RuntimeSource.DefaultSettingSourceLocations) {
            resultKey += "_ContentRuntime_";
        }
        if (!utilities_1.Utilities.isNullOrUndefined(formFactor)) {
    ...
    static _oSFFormFactorToInputFormFactor(osfFormFactor) {
        switch (osfFormFactor) {
            case osfmos_1.OSF.FormFactor.Default:
            case osfmos_1.OSF.FormFactor.Desktop:
                return constants_1.Constants.InputDesktopFormFactor;
                break;
            case osfmos_1.OSF.FormFactor.Phone:
                return constants_1.Constants.InputMobileFormFactor;
                break;
            case osfmos_1.OSF.FormFactor.Tablet:
                return constants_1.Constants.InputTabletFormFactor;
                break;
            default:
                return constants_1.Constants.InputDesktopFormFactor;
                break;
    ...
    static _inputFormFactorToMOSFormFactor(inputFormFactor) {
        if (inputFormFactor === constants_1.Constants.InputDesktopFormFactor) {
            return MOS.FormFactors.Desktop;
        }
        else if (inputFormFactor === constants_1.Constants.InputMobileFormFactor) {
            return MOS.FormFactors.Mobile;
        }
        else {
            utilities_1.Utilities.logError("Unrecognized or unused form factor: " + inputFormFactor);
            return MOS.FormFactors.Desktop;
        }
    }
}
