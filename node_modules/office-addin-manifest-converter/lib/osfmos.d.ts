...
declare namespace OSF {
    ...
    class RequirementsChecker {
        ...
        _checkSetsForMos(askedSets: any): boolean;
...
declare namespace OSF {
    ...
    export enum FlightTreatmentNames {
        ...
        ExcelApiUndo26 = "Microsoft.Office.SharedOnline.ExcelApiUndo26Bump",
        ExcelApiUndo27 = "Microsoft.Office.SharedOnline.ExcelApiUndo27Bump",
        ExcelApiUndo28 = "Microsoft.Office.SharedOnline.ExcelApiUndo28Bump",
        ExcelApiUndo29 = "Microsoft.Office.SharedOnline.ExcelApiUndo29Bump",
        Ribbon11Enabled = "Microsoft.Office.SharedOnline.Ribbon11Enabled",
        ...
        MosOsfCacheFix = "Microsoft.Office.SharedOnline.MosOsfCacheFix",
...
declare namespace Mos {
    ...
    class Acquisition implements IAcquisition {
        ...
        static getAppState(acquisition: Mos.Acquisition): OSF.OmexState;
        static getClientAppStatus(acquisition: Mos.Acquisition): OSF.OmexClientAppStatus;
    ...
    class ContentRuntimes implements IContentRuntimes {
        requirements: Requirements;
        id: string;
        code: Code;
    ...
    class Alternates implements IAlternates {
        requirements: Requirements;
        prefer: Prefer;
        hide: any;
    ...
    class AlternateIcons implements IAlternateIcons {
        icon: Icons;
        highResolutionIcon: Icons;
        constructor(data?: IAlternateIcons);
        init(_data?: any): void;
        static fromJS(data: any): AlternateIcons;
        toJSON(data?: any): any;
    }
    interface IAlternateIcons {
        icon: Icons;
        highResolutionIcon: Icons;
    }
    class Prefer implements IPrefer {
        comAddin: ComAddin;
        constructor(data?: IAlternates);
        init(_data?: any): void;
    ...
    class ComAddin implements IComAddin {
        progId: string;
...
declare namespace OfficeExt {
    class ManifestUtil {
        static isSameId(id1: string, id2: string): boolean;
        static versionLessThan(version1: any, version2: any): boolean;
        static IsManifestFromXMLString(manifest: string | Manifest): boolean;
        static ParseManifest(para: any, uiLocale: any, correlation?: string): Manifest;
        static IsManifestFromAcquisitionForMos(manifest: string | Mos.Acquisition): boolean;
        static ParseManifestFromAcquisitionForMos(manifest: Mos.Acquisition, uiLocale: any, correlation?: string): Mos.AppMetadata;
...
declare namespace Mos {
    class AppMetadata extends OSF.Manifest.Manifest {
        ...
        private _populateBaseAllowSnapshot;
        private _populateBaseHighResolutionIconUrls;
        private _populateBaseEquivalentAddins;
        containsAddinCommands(manifestHostType: any): boolean;
        containsCustomFunctions(manifestHostType: any): boolean;
        ...
        getExtensionAlternates(): Mos.Alternates[];
        ...
        static checkRequirements(requirements: Mos.Requirements, caller?: string): boolean;
